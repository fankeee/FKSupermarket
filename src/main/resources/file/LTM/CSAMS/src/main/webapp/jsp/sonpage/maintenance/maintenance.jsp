		...
		<div id="content-navigation">
			<div class="tabbable" id="tabs-296400">
				<ul class="nav nav-tabs">
					<li class="active">
						<a href="#part1" data-toggle="tab" id="text-a">数据库备份</a>
					</li>
					<li>
						<a href="#part2" data-toggle="tab" id="text-a">数据库恢复</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="part1">
						<iframe src="${pageContext.request.contextPath }/category/findAllTable.action" id="framework-son" name="framework-son" frameborder="0"></iframe>
					</div>
					<div class="tab-pane " id="part2">
						<iframe src="maintenanceson/maintenance_son2.jsp" id="framework-son" name="framework-son" frameborder="0"></iframe>
					</div>
				</div>
			</div>
		</div>
